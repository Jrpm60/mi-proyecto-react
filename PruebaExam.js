...
2.-
En JavaScript, cuando trabajas con objetos o arreglos (tipos no primitivos), el paso de valores es por referencia. 
Esto significa que cuando asignas un objeto a otra variable, ambas variables apuntan al mismo objeto en memoria. 
...
7.-
¿Qué es ECMAScript? ECMAScript es un estándar de especificación que define las reglas, las estructuras y las características del lenguaje de programación. 
JavaScript es la implementación más conocida de ECMAScript, pero existen otros lenguajes como JScript y ActionScript que también siguen este estándar.
...
¿Qué funciones tiene cada una de estas capas?
    ...
    Capa de lógica de negocio: 
        Procesa las solicitudes del usuario, aplica las reglas de negocio y genera los datos necesarios para la capa de presentación. 
        Actúa como intermediaria entre la interfaz de usuario y la base de datos. 
...
¿Cómo se comunican estas capas entre sí?
    ...
    puede implicar protocolos como HTTP, APIs RESTful, o incluso comunicación interna mediante funciones dentro del mismo sistema. 
    
¿Cuáles son las ventajas y desventajas de utilizar una arquitectura en 3 capas?

    Ventajas: Separación de responsabilidades: Cada capa tiene una responsabilidad bien definida, 
    ...
    Desventajas: Complejidad: La gestión de tres capas puede hacer que la arquitectura sea más compleja, especialmente en aplicaciones más pequeñas. 
...
¿Cuál es la diferencia entre una solicitud síncrona y asíncrona en AJAX?
    ...
    Síncrona: La solicitud bloquea la ejecución del código hasta que se obtiene la respuesta del servidor. 
    Esto puede hacer que la página se congele o sea lenta. Asíncrona: La solicitud no bloquea la ejecución del código. 
    El navegador puede seguir realizando otras tareas mientras espera la respuesta, mejorando la fluidez de la experiencia del usuario. */